	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= 30; i++) {
			...
			case 1:
				...
				System.out.println("1. 한국타이어 2. 금호 타이어 3. oem 타이어");
				System.out.print(">>>");
				int select1 = scanner.nextInt();
				if (select1 == 1) {
					car.fl = new HankookTire(90, "앞왼");
					System.out.println("한국 타이어 교체 성공!!");
				}else if (select1 ==2) {
					car.fl = new KumhoTire2(90, "앞왼");
					System.out.println("금호 타이어 교체 성공!!");
				} else {
				...
				break;
			case 2:
				System.out.println("앞오쪽 타이어가 펑크!!!!");
				System.out.println("1. 한국타이어 2. 금호 타이어 3. oem 타이어");
				System.out.print(">>>");
